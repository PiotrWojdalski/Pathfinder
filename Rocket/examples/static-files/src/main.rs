...
fn index() -> Template {
    Template::render("index", context! {
        JobDescription: "Strona została stworzona aby przybliżyć wszystkie zespoły w SSC"
    })
}
...
fn eco() -> Template {
    Template::render("index", context! {
        JobDescription: "Zarządzanie i konfiguracja Linux’a (RedHat ,CentOS).
...
fn bi() -> Template {
    Template::render("index", context! {
        JobDescription: "Support oferuje wsparcie użytkownikom wzakresie rozwiązań dostarczanych przez Business Intelligence ( BI pozwala zaprezentować dane w przyjazny sposób i ułatwić analizę biznesową Z perspektywy użytkownika końcowego Business Intelligence kojarzony jest
